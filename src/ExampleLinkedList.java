...
public class ExampleLinkedList<AnyType> implements Iterable<AnyType>
{
 ...
 /**
   ...
   *  Complexity: O(n^2)
   */
   public  ExampleLinkedList<AnyType> copy1()
   {
      ExampleLinkedList<AnyType> twin = new ExampleLinkedList<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public ExampleLinkedList<AnyType> copy2()
   {
      ExampleLinkedList<AnyType> twin = new ExampleLinkedList<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public ExampleLinkedList<AnyType> reverse()
   {
      ExampleLinkedList<AnyType> list = new ExampleLinkedList<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public ExampleLinkedList<AnyType> copy3()
   {
      ExampleLinkedList<AnyType> twin = new ExampleLinkedList<AnyType>();
      Node<AnyType> tmp = head;
...
/*****   Include the main() for testing and debugging  *****/
   ...
   public static void main(String[] args)
   {
      ...
      System.out.println(list);
		...
		ExampleLinkedList<String> twin = list.copy3();
